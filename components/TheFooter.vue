<template>
	<div>
		<footer class="text-gray-700 border-t-2 body-font">
			<div class="container px-5 pt-10 mx-auto">
				<div class="flex flex-wrap order-first text-center md:text-left">
					...
					<div class="w-full px-4 lg:w-1/4 md:w-1/2">
						...
						>
							<input
								class="w-40 px-4 py-2 mr-2 text-base bg-gray-100 border border-gray-400 rounded sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 focus:outline-none focus:border-teal-500"
								placeholder="Placeholder"
								type="text"
							/>
							<button
								class="inline-flex flex-shrink-0 px-6 py-2 text-white bg-teal-500 border-0 rounded lg:mt-2 xl:mt-0 focus:outline-none hover:bg-teal-600"
							>
								Button
							</button>
						</div>
			...
			<div class="bg-white">
				...
				>
					...
					<p class="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0">
						© 2020 Happy Life ID —
						<a
							href="https://twitter.com/happylifeid"
