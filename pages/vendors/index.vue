<template>
  <div class="container flex flex-col justify-center mt-24 lg:mt-32 mx-auto">
    ...
    <!-- <t-button class="mt-4 mx-4" @click="add">add</t-button> -->
    <p
  ...
  data() {
    return {
      ...
      categories: [
        ...
        {
          name: "Others (Unique Sercices)",
          slug: "others-unique-service",
          id: 7,
        },
